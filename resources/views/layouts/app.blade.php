                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <!-- Authentication Links -->
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ (request()->route()->getName() == 'sell_vehicle') ? 'active' : '' }}" href="{{ route('sell_vehicle') }}">Sälj bil</a>
                            </li>
                            <li class="nav-item">
        ...
        <footer class="container-fluid bg-dark text-white text-center ">
            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div class="col-12 col-md-4 mb-3 mt-3">
                    ...
                    <small>Mån - Fre: {{ config('company.working-hours-mon-fri') }}</small><br>
                    <small>Lördag: {{ config('company.working-hours-sat') }}</small><br>
                    <small>Söndag: {{ config('company.working-hours-sun') }}</small><br>
                </div>
            </div>
        </footer>
    </div>
